...
const textBounds: THREE.Box2 = new THREE.Box2(
    new THREE.Vector2(),
    new THREE.Vector2()
);
...
function addGUIControls() {
    ...
    gui.add(guiOptions, "input").onFinishChange((value: string) => {
        ...
        textCanvas.fontCatalog
            .loadCharset(textSample, textRenderStyle)
            .then(() => {
                assetsLoaded = true;
            });
    });
    ...
    gui.addColor(guiOptions, "backgroundColor").onChange(() => {
        textRenderStyle.backgroundColor!.r =
            guiOptions.backgroundColor.r / 255.0;
        textRenderStyle.backgroundColor!.g =
            guiOptions.backgroundColor.g / 255.0;
        textRenderStyle.backgroundColor!.b =
            guiOptions.backgroundColor.b / 255.0;
    });
...
function main() {
    ...
    webglRenderer.domElement.addEventListener("contextmenu", e =>
        e.preventDefault()
    );
    ...
    FontCatalog.load("resources/Default_FontCatalog.json", 2048).then(
